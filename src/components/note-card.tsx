...
export function NoteCard(props: INoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className='text-left relative rounded-md flex flex-col overflow-hidden bg-slate-800 p-5 gap-y-3 hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
